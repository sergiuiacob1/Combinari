...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_Text9Copy2}", "mouseenter", function(sym, e) {
         // Show an Element.
         sym.$("com9").show();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_Text9Copy2}", "mouseleave", function(sym, e) {
         // Hide an Element.
         sym.$("com9").hide();
