...
<gap-fill>int comb(int k)
{if (<question-record><question></question><answer><text>k==0</text><feedback></feedback><correct>1</correct></answer><clue>Caz elementar.</clue></question-record>) return 1;
return (<question-record><question></question><answer><text>n-k+1</text><feedback></feedback><correct>1</correct></answer><clue></clue></question-record>)*comb(k-1)/k;
}
</gap-fill>
</data>
...
<instructions>Completa&amp;#x0026;#355;I urm&amp;#x0026;#259;toarea func&amp;#x0026;#355;ie recursiv&amp;#x0026;#259; pentru ca aceasta s&amp;#x0026;#259; calculeze combin&amp;#x0026;#259;ri de n luate c&amp;#x0026;acirc;te k.
